...
Common labels nginx
*/}}
{{- define "nginx-phpfpm-nginx.labels" -}}
helm.sh/chart: {{ include "nginx-phpfpm.chart" . }}
{{ include "nginx-phpfpm-nginx.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "nginx-phpfpm-nginx.selectorLabels" -}}
app.kubernetes.io/name: {{ include "nginx-phpfpm.name" . }}-nginx
